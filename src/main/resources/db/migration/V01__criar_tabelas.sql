CREATE TABLE usuario (
    ...
    idTipoUsuario character varying(100) NOT NULL,
    tipoPessoa character varying(15) NOT NULL,
);

ALTER TABLE ONLY usuario
    ADD COLUMN telefoneCelular character varying(20);
	
ALTER TABLE ONLY usuario
    ADD COLUMN telefoneFixo character varying(20);
	
ALTER TABLE ONLY usuario
    ADD COLUMN tipoPessoa character varying(15);
...
INSERT INTO usuario (id, nome, email, senha, cpfCnpj, idTipoUsuario) VALUES
	(99, 'Admin', 'admin@admin.com', '$2a$10$g.wT4R0Wnfel1jc/k84OXuwZE02BlACSLfWy6TycGPvvEKvIm86SG','00000000000', 'VENDEDOR');
