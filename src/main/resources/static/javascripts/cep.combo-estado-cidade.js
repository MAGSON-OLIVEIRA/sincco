...
Sincco.ComboCidade = ( function(){
	...
	function onBuscarCidadesFinalizado(cidades){
		...
		console.log(codigoCidadeSelecionada );
	}

	function reset(){
		this.combo.html('<option value "">Selecione cidade</option>');
		this.combo.val('');
...
$(function(){
	...
	var comboEstado = new Sincco.ComboEstado();
	comboEstado.iniciar();
	
	var comboCidade = new Sincco.ComboCidade(comboEstado);
	comboCidade.iniciar();
